...
public class OrderActivityBasicTest {
    ...
    @Test
    public void testClickIncrementButton_ChangesQuantityAndCost() {
        // find the view
        ViewInteraction viewInteraction = onView((withId(R.id.increment_button)));

        // click the button
        viewInteraction.perform(click());

        // verify quantity and cost changed
    ...
    public void clickDecrementButton_ChangesQuantityAndCost() {
        ...
        ViewInteraction viewInteraction = onView((withId(R.id.decrement_button)));
