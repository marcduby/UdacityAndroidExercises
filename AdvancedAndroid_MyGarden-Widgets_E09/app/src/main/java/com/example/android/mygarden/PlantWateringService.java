...
/**
 * Created by mduby on 9/15/18.
 */

public class PlantWateringService extends IntentService {
    // instance variables
    private final static String TAG = PlantWateringService.class.getName();
    ...
    public static void startActionWaterPlants(Context context) {
        ...
        // log
        Log.i(TAG, "Launching water plant intent service action");
    ...
    public static void startActionUpdatePlantWidgets(Context context) {
        ...
        // log
        Log.i(TAG, "Launching update plant widgets intent service action");
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_WATER_PLANTS.equals(action)) {
                ...
                this.handleActionUpdatePlantWidgets();
            }
        }
    }
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        // E-05: adding the grid view for the plants
        appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetIds, R.id.plant_widget_grid_view);
    ...
    private void handleActionWaterPlants() {
        ...
        // log
        Log.i(TAG, "Handling intent service action");
